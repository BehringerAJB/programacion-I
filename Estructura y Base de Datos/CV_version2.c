...
int main()
{
 ...
 registro info[]={{100235,"Nebulizador",50,2145.20},{100312,"Tensiometro",120,1159.35},
	             {200045,"Caloventor",35,846.00},{200511,"Estufa halogena",15,972.58},
	             {400805,"Afeitadora",100,1215.40},{400322,"Cortadora de Cabello",210,829.45}}; // Datos Originales

 registro infocom[]={{500100,"Reproductor de DVD",24,3200.53},{100312,"Tensiometro",50,1159.35},
	             {500235,"Televisor 21",30,8565.60},{200511,"Estufa halogena",30,972.58}}; // Datos Compras
  pori=NULL;
  pcomp=NULL;
  auxpori=NULL;
  lista=NULL;
...
void mostrar(FILE*x)
{
   registro r;
	...
	while(!feof(x))
	{
		p("\n\n%3d\t\t%-20s\t%6d\t\t\t%8.2f",r.cod,r.desc,r.cant,r.pre);
		fread(&r,sizeof(r),1,x);
	}
}
